...
export default function Sidebar() {
    ...
    return (
        <aside className="hidden md:flex flex-col w-60 shrink-0 bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-800 shadow-sm">
            ...
            <div className="px-6 py-4 border-t border-gray-100 dark:border-gray-800">
                <p className="text-xs text-gray-400 dark:text-gray-600">FinTrack v1.0</p>
            </div>
        </aside>
    );
}
